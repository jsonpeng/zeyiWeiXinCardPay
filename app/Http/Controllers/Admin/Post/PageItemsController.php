...
class PageItemsController extends AppBaseController
{
    ...
    public function index(Request $request,$page_id)
    {
        ...
        return view('admin.common.page_items.index')
            ->with('page',$page)
    ...
    public function create($page_id)
    {
        ...
        return view('admin.common.page_items.create')
                ->with('page',$page);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.common.page_items.show')->with('pageItems', $pageItems);
    }
    ...
    public function edit($page_id,$id)
    {
        ...
        return view('admin.common.page_items.edit')
                ->with('page',$page)
                ->with('pageItems', $pageItems);
    }
