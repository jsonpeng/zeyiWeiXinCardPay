...
class CustomPostTypeController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.common.custom_post_types.index')
    ...
    public function create()
    {
        ...
        return view('admin.common.custom_post_types.create')
                ->with('cats',$cats);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.common.custom_post_types.show')->with('customPostType', $customPostType);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.common.custom_post_types.edit')
