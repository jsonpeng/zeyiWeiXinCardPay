...
class PostController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        $posts = $posts->paginate(defaultPage());
    ...
    public function create(Request $request)
    {
        ...
        // return $attach;
        $categories = $this->categoryRepository->getCascadeCategories();
        return view('admin.common.posts.create')
            ->with('categories', $categories)
            ->with('all',$all)
            ->withInput($input);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.common.posts.show')->with('post', $post);
    }
    ...
    public function edit(Request $request,$id)
    {
        ...
        return view('admin.common.posts.edit')
            ->with('post', $post)
