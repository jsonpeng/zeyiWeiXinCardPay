...
class CustomPageTypeController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.common.custom_page_types.index')
    ...
    public function create()
    {
        ...
        return view('admin.common.custom_page_types.create')
                ->with('all',$all);
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.common.custom_page_types.show')->with('customPageType', $customPageType);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.common.custom_page_types.edit')
