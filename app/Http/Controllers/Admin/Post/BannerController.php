...
class BannerController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.common.banners.index')
    ...
    {
        return view('admin.common.banners.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.common.banners.show')->with('banner', $banner);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.common.banners.edit')->with('banner', $banner);
    }
