...
class PageController extends AppBaseController
{
    ...
    public function index(Request $request)
    {
        ...
        */
        ...
        return view('admin.common.pages.index')
            ->with('pages', $pages)
    ...
    {
        return view('admin.common.pages.create');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.common.pages.show')->with('page', $page);
    }
...
//        return $page->pageItems()->where('name','地址')->first()->value;
        ...
        return view('admin.common.pages.edit')->with('page', $page);
    }
