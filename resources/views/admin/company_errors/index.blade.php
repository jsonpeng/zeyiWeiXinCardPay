...
@section('content')
    <section class="content-header">
        <h1 class="pull-left">企业纠错信息列表</h1>
     {{--    <h1 class="pull-right">
                    ...
                    <div class="form-group col-lg-3 col-md-4 col-sm-6 col-xs-6">
                        <label for="snumber">状态</label>
                            <select name="status" class="form-control">
                                    <option value="-1" @if(!array_key_exists('status',$input)) @endif>全部</option>
                                    <option value="0" @if(array_key_exists('status',$input)) @endif>未读</option>
                                    <option value="1" @if(array_key_exists('status',$input)) @endif>已读</option>
                            </select>
                    </div>
