            ...
            <div class="box-body">
                <form id="projects_search">
                    <div class="form-group col-lg-2 col-md-3 col-sm-12 col-xs-12">
                        <label for="order_delivery">项目名称</label>
                    ...
                    <div class="form-group col-lg-2 col-md-4 col-sm-6 col-xs-6">
                        <label for="snumber">项目金额(万元)</label>
                        <div class="row">
                    ...
                    <div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-6">
                        ...
                        <select class="form-control" name="status">
                            ...
                            <option value="正常" @if (array_key_exists('status', $input) && $input['status'] == '正常') selected="selected" @endif>正常</option>
                            <option value="暂停" @if (array_key_exists('status', $input) && $input['status'] == '暂停') selected="selected" @endif>暂停</option>
                        </select> 
                    </div>
                    <div class="form-group col-lg-2 col-md-3 col-sm-6 col-xs-6">
                        <label for="auth_status">审核状态</label>
                        <select class="form-control" name="auth_status">
                            <option value="" @if (!array_key_exists('auth_status', $input)) selected="selected" @endif>全部</option>
                            <option value="审核中" @if (array_key_exists('auth_status', $input) && $input['auth_status'] == '审核中') selected="selected" @endif>审核中</option>
                            <option value="通过" @if (array_key_exists('auth_status', $input) && $input['auth_status'] == '通过') selected="selected" @endif>通过</option>
                            <option value="不通过" @if (array_key_exists('auth_status', $input) && $input['auth_status'] == '不通过') selected="selected" @endif>不通过</option>
                        </select>
                    </div>
