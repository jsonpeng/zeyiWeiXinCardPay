    ...
    <div class="box box-solid">
        ...
        <div class="box-body">
                ...
                <div class="form-group">
                    {!! Form::label('status', '审核状态:') !!}
                     <select name="status" class="form-control" >
                            <option value="0" @if(empty($caompany)) selected="selected" @endif>审核中</option>
                            <option value="1" @if(!empty($caompany)) @if($caompany->status===1) selected="selected" @endif @endif>通过</option>
                            <option value="2" @if(!empty($caompany)) @if($caompany->status===2) selected="selected" @endif @endif>不通过</option>
                    </select>
                </div>
                <!-- Mobile Field -->
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    {!! Form::number('collect', null, ['class' => 'form-control']) !!}
                </div>
          </div>
    </div>
</div>